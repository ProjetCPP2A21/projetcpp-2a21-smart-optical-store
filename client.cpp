...
bool client::ajouter_client()
{
    ...
    query.prepare("INSERT INTO client (id_client, nom, prenom, date_naissance, num_tel,email, date_inscri, point_fedelite) "
                  "VALUES (:id_client, :nom, :prenom, :date_naissance, :num_tel,:email, :date_inscri, :point_fedelite)");
